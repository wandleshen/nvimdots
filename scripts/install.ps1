...
'@
	...
	info -Msg "This script will install wandleshen/nvimdots to:"
	...
	if ($USE_SSH) {
		clone_repo -WithURL 'git@github.com:wandleshen/nvimdots.git'
	} else {
		clone_repo -WithURL 'https://github.com/wandleshen/nvimdots.git'
	}
...
- Project Homepage:
    https://github.com/wandleshen/nvimdots
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
- Further documentation (including executables you |must| install for full functionality):
    https://github.com/wandleshen/nvimdots/wiki/Prerequisites
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
'@
